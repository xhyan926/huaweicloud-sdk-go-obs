...
public class AppendObjectIT {
    ...
    @Test
    public void test_appendObject_with_chinese_metadata_001() {
        String bucketName = testName.getMethodName().replace("_", "-").toLowerCase(Locale.ROOT);
        ObsClient obsClient = TestTools.getPipelineEnvironment();
        String objectKey = "test_appendObject_with_chinese_metadata_001";
        ...
        AppendObjectResult appendResult = obsClient.appendObject(request);

        assertEquals(200, appendResult.getStatusCode());
    ...
    @Test
    public void test_appendObject_with_chinese_metadata_002() {
        String bucketName = testName.getMethodName().replace("_", "-").toLowerCase(Locale.ROOT);
        ObsClient obsClient = TestTools.getPipelineEnvironment();
        String objectKey = "test_appendObject_with_chinese_metadata_002";
    ...
    @Test
    public void test_appendObject_with_chinese_metadata_003() {
        String bucketName = testName.getMethodName().replace("_", "-").toLowerCase(Locale.ROOT);
        ObsClient obsClient = TestTools.getPipelineEnvironment();
        String objectKey = "test_appendObject_with_chinese_metadata_003";
