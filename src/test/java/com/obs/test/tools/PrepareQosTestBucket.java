...
public class PrepareQosTestBucket implements TestRule {
    ...
    public Statement apply(Statement statement, Description description) {
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                String location = PropertiesTools.getInstance(configFile).getProperties("environment.snapshot.location");
